...
import { Shield, Eye, EyeOff, Github, Chrome, Smartphone } from "lucide-react"
...
function LoginForm() {
  ...
  const { login, mfaLogin, mfaRequired, mfaToken, clearMfa } = useAuthStore()
          ...
          <Card className="glass-card">
            ...
            <CardContent>
              <form onSubmit={handleMfaSubmit} className="space-y-4">
                ...
                <Button type="submit" className="w-full" variant="cyber" disabled={loading || mfaCode.length !== 6}>
